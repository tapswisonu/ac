    ...
    <html lang="en">
      <body className={`${inter.className} min-h-screen flex flex-col bg-gray-50`}>
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <a href="#" className="bg-orange-400 hover:bg-orange-500 text-black rounded-full p-4 shadow-lg flex items-center justify-center transition-transform hover:scale-105">
